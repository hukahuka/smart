...
Treat_Button_GPIO_pin=13
Hopper_GPIO_Pin=11
Hopper_Spin_Time=0.6
Log_TreatService_Filename=/var/www/feeder/feeder/logs/feederTreatService.log
...
Motion_Camera_Site_Address=http://192.168.1.38:8080/stream/webrtc
